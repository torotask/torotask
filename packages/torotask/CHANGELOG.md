...
- Reclaim step state and data-store blobs left behind by `removeOnComplete` / `removeOnFail` ([#41](https://github.com/torotask/torotask/pull/41)) ([`39a5c1d`](https://github.com/torotask/torotask/commit/39a5c1dbdeb76a4b6b9fe9ac015ad59be87f4e80))
...
- Add `defineTaskWithResult<T>()` helper function for explicit result types ([#27](https://github.com/torotask/torotask/pull/27)) ([`376d1bb`](https://github.com/torotask/torotask/commit/376d1bb6405ba18762cd216b588ce748f77ad87a))
...
- Allow overriding the `parent` option in step executor methods ([#21](https://github.com/torotask/torotask/pull/21)) ([`614de4f`](https://github.com/torotask/torotask/commit/614de4feaf11acab92733588900a1e3a7825a578))
